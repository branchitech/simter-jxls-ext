 ...
 * @author RJ
 */
public class MergeCellByCommentTest {
  private static Logger logger = LoggerFactory.getLogger(MergeCellByCommentTest.class);

  @Test
  @SuppressWarnings("unchecked")
  public void merge() throws Exception {
    // template
    InputStream template = getClass().getClassLoader().getResourceAsStream("templates/merge-cell-by-comment.xlsx");

    // output to
    File out = new File("target/merge-cell-by-comment-result.xlsx");
    ...
    // get comment area
    XlsCommentAreaBuilder.addCommandMapping(EachCommand.COMMAND_NAME, EachCommandWithAreaListener.class);
