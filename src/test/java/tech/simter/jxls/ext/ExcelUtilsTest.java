...
public class ExcelUtilsTest {
  ...
  public void xlsx() throws Exception {
    // template
    InputStream template = getClass().getClassLoader().getResourceAsStream("templates/test.xlsx");

    // output to
    File out = new File("target/test.xlsx");
  ...
  public void xls() throws Exception {
    // from template
    InputStream template = getClass().getClassLoader().getResourceAsStream("templates/test.xls");

    // output to
    File out = new File("target/test.xls");
    if (out.exists()) out.delete();
    OutputStream output = new FileOutputStream(out);
